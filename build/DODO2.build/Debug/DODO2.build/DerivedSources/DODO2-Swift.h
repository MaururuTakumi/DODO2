...
#ifndef DODO2_SWIFT_H
#define DODO2_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DODO2",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC5DODO211AppDelegate")
...
@class NSEvent;
@class NSCoder;
SWIFT_CLASS("_TtC5DODO220FocusableSearchField")
@interface FocusableSearchField : NSSearchField
...
SWIFT_CLASS("_TtC5DODO28KeyPanel")
...
@class NSWindow;
SWIFT_CLASS("_TtC5DODO221PanelWindowController")
...
SWIFT_CLASS("_TtC5DODO217QuickAddTextField")
@interface QuickAddTextField : NSTextField
@property (nonatomic, readonly) BOOL acceptsFirstResponder;
- (BOOL)becomeFirstResponder SWIFT_WARN_UNUSED_RESULT;
- (void)mouseDown:(NSEvent * _Nonnull)event;
- (nonnull instancetype)initWithFrame:(NSRect)frameRect OBJC_DESIGNATED_INITIALIZER;
